...
/*
var url_bible_by = 'https://bible.by/i/php/strong.php?greek=3973';
fetch(url_bible_by)
...
var sbi = document.querySelector('#sidebarInner');

/*
p.append(biblia.Translation);

p.append(biblia.Books[0].BookId);
p.append(biblia.Books[0].BookName);
p.append(biblia.Books[0].Chapters[0].ChapterId);
p.append(biblia.Books[0].Chapters[0].Verses[0].VerseId);
p.append(biblia.Books[0].Chapters[0].Verses[0].Text);
sbi.append(p);
*/

/*
urlWeb ='https://gist.githubusercontent.com/a1ip/0a5ec1b89e79b4490ef5992a80e72eeb/raw/643fb1089165676903b05852cb7d72cb2f51b2f8/rst.json';
//urlLocal ='./rst.json';
...
var sbi = document.querySelector('#col3 .colsInner');
//var sbi = document.querySelector('#sidebarInner');


//showChapter('rstStrong','#col1', 5,34);
showTrans(0, 1);
/*
setTimeout(function(){
    showTrans(2, 5);
...
function showChapter(Translation, divId, book, chapter, verseNumber = null, to_verseNumber = null){
    ...
    //getShortBookName();
    if(Translation == 'rstStrong'){
        //url = 'https://raw.githubusercontent.com/SergioKov/bible/main/modules/json/RST+.json';
        url = 'http://localhost/bibleapp/modules/json/RST+.json';
    }
    if(Translation == 'rsti2'){
        //url = 'https://raw.githubusercontent.com/SergioKov/bible/main/modules/json/RSTi2.json';
        url = 'http://localhost/bibleapp/modules/json/RSTi2.json';
    }
    if(Translation == 'nrt'){
        //url = 'https://raw.githubusercontent.com/SergioKov/bible/main/modules/json/NRT.json';
        url = 'http://localhost/bibleapp/modules/json/NRT.json';
    }
    if(Translation == 'ukr_ogi'){
        //url = 'https://raw.githubusercontent.com/SergioKov/bible/main/modules/json/ukr_ogi.json';
        url = 'http://localhost/bibleapp/modules/json/ukr_ogi.json';
    }
    ...
    fetch(url)
        ...
        .then((biblia) => {
            ...
            //console.log(biblia);
            //console.log(biblia.Translation);
            divTrans.innerHTML = biblia.BibleShortName;
            
            //Book
            var h2 = document.createElement('h2');
            h2.append(biblia.Books[book_i].BookName);
            divShow.append(h2); 

            //Chapter
            //console.log(biblia.Books[book_i].Chapters[chapter_i].ChapterId);
            var h4 = document.createElement('h4');
            //h4.append('Глава '+biblia.Books[book_i].Chapters[chapter_i].ChapterId);
            //h4.append(biblia.Books[book_i].Chapters[chapter_i].ChapterId);
            h4.append(biblia.Books[book_i].Chapters[chapter_i].ChapterText);
            divShow.append(h4); 

            //Verse
            biblia.Books[book_i].Chapters[chapter_i].Verses.forEach( (verse,i_v) => {
                //console.log(verse.VerseId, verse.Text ); 
                //console.log(verse);

                var p = document.createElement('p');
                p.id = biblia.Translation+'__'+book + '__' + chapter + '__' + verse.VerseId;
                p.setAttribute('data-verse',verse.VerseId);

                var a = document.createElement('a');
                a.href = '#';
                a.classList.add = 'blink';
                a.innerHTML = biblia.Books[book_i].ShortNames[0] + biblia.Books[book_i].Chapters[chapter_i].ChapterId + ':' + verse.VerseId;
                p.append(a);
                p.append(' ');

                //Номера Стронга в стихах (RST+)
                if(biblia.StrongNumbers == "Y"){
                    let t = verse.Text;
                    var arr_t = t.split(' ');
                ...
                if(biblia.Notes == 'Y'){
                    ...
                    if(t.includes(biblia.NoteSign)){// '*'
                        let arr_t0 = t.split(biblia.NoteSign);
                        let before_Note = arr_t0[0];

                        if(t.includes(biblia.StartNoteSign) && t.includes(biblia.EndNoteSign)){
                            let arr_t1 = t.split(biblia.StartNoteSign);//'[('
                            let arr_t2 = arr_t1[1].split(biblia.EndNoteSign);//')]'
                            ...
                            span_t.innerHTML = biblia.NoteSign;
                ...
                if(biblia.Titles == 'Y'){
                    ...
                    if(t.includes(biblia.StartTitleSign) && t.includes(biblia.EndTitleSign)){
                        let arr_t1 = t.split(biblia.StartTitleSign);//'[('
                        let before_Title = arr_t1[0];
                        let arr_t2 = arr_t1[1].split(biblia.EndTitleSign);//')]'
                ...
                if(biblia.StrongNumbers == "N" && biblia.Notes == 'N' && biblia.Titles == 'N'){
                    p.append(verse.Text);
                }
        ...
        .then((bq) => {
            ...
            .then((bookModule) => {
                ...
                if(bookModule.includes('<h2>')){
                    ...
                    //h2.innerHTML = (bq.HTMLFilter == 'Y') ? htmlEntities(h2.innerHTML) : h2.innerHTML ;
                    divShow.append(h2); 
                    if(bq.HTMLFilter == 'Y'){
                ...
                if(typeof nb[chapter] !== 'undefined'){
                    ...
                    //Chapter, Verse
                    nb[chapter].split('<p>').forEach( (el,i) => {//antes ok
                    //bookModule.split('<p>').forEach( (el,i) => {
                        //console.log(el);
                        ...
                        if(i == 0){
                            ...
                            //h4.innerHTML = (bq.HTMLFilter == 'Y') ? htmlEntities(h4.innerHTML) : h4.innerHTML ;
                            divShow.append(h4);
                            if(bq.HTMLFilter == 'Y'){
            ...
            .then(() => {
                ...
                if(verseView !== null && verseView != ""){
                    ...
                    if(to_verseNumber !== null && to_verseNumber != ""){
                        ...
                        //only one verse of each translation
                        if(verseNumber !== null && verseNumber != ""){
                            document.querySelectorAll('#col1 .colsInner [data-verse="'+verseNumber+'"]').forEach(el=>{
                                el.classList.add('active_one');
                            });
                        }
                    }                
...
function selVerse(e){
    ...
    e.srcElement.classList.add('li_active');
...
function sel(e, par, show_chapter = null, trans = null){
    ...
    //Select li Book
    if(par == 'b'){
        document.querySelector('#v_book').classList.add('ul_active');
        ...
        .then(data => {
            ...
            document.querySelector('#v_book').innerHTML = '';
            ...
            arr_booksBible.forEach((el_b,i_b,arr_b) =>{              
                ...
                li.addEventListener('click',selBook);
                document.querySelector('#v_book').append(li);
                ...
                if(i_b == 38 || i_b == 65){//Малахия //Откровение
                    ...
                    document.querySelector('#v_book').append(li_break);
                }
                //console.log(el_b);
            });
        })
    ...
    //Select li Chapter
        ...
        document.querySelector('#v_chapter').classList.add('ul_active');
            ...
            //console.log(chapter_PathName);
                ...
                .then(data => {
                    ...
                    for(let index = 1; index <= arr_chapters.length - 1; index++) {
                        ...
                        li_ch.addEventListener('click',selChapter);
                        document.querySelector('#v_chapter').append(li_ch);           
                    }
                })
                .catch(error => { 
                    // Código a realizar cuando se rechaza la promesa
    ...
    //Select li Verse
        ...
        document.querySelector('#v_verse').classList.add('ul_active');
        bcv_line.classList.remove('b_line');
        bcv_line.classList.remove('c_line');
        ...
        .then(data => {
            ...
            //console.log(chapter_PathName);
                ...
                .then(data => {
                    ...
                    window.arr_verses = data.split('<h4>')[id_chapter + 1].split('<p>');
                    ...
                    for(let index = 1; index <= window.arr_verses.length - 1; index++) {
                        ...
                        li_v.addEventListener('click',selVerse);
                        document.querySelector('#v_verse').append(li_v);
                    }
                })
                .catch(error => { 
                    // Código a realizar cuando se rechaza la promesa
